import { Button, Container, Form, Row, Col, Modal, ProgressBar, ButtonGroup } from "react-bootstrap";
...
function Crush() {
    ...
    return (
        <>
            ...
            <Modal show={infoModal} centered>
                <Modal.Header>
                    <Modal.Title><AiFillInfoCircle />&nbsp;&nbsp;Informasi</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container fluid className="information-wrapper">
                        ...
                        <Container className="mt-3">
                            <Row>
                                ...
                                <Col className="d-flex justify-content-center my-2">
                                    <Button className="keypad-number shadow-none" name="3" onClick={numberHandler} disabled>3</Button>
                                    <Button className="keypad-number shadow-none" name="4" onClick={numberHandler} disabled>4</Button>
                                </Col>
                                :
                                <Col className="d-flex justify-content-center my-2">
                                    <Button className="keypad-number shadow-none" name="3" onClick={numberHandler}>3</Button>
                                    <Button className="keypad-number shadow-none" name="4" onClick={numberHandler}>4</Button>
                                </Col>
                                }
                            </Row>
                            <Row>
                                {length ?
                                <Col className="d-flex justify-content-center my-2">
                                    <Button className="keypad-number shadow-none" name="5" onClick={numberHandler} disabled>5</Button>
                                    <Button className="keypad-number shadow-none" name="6" onClick={numberHandler} disabled>6</Button>
                                    <Button className="keypad-number shadow-none" name="7" onClick={numberHandler} disabled>7</Button>
                                </Col>
                                :
                                <Col className="d-flex justify-content-center my-2">
                                    <Button className="keypad-number shadow-none" name="5" onClick={numberHandler}>5</Button>
                                    <Button className="keypad-number shadow-none" name="6" onClick={numberHandler}>6</Button>
                                    <Button className="keypad-number shadow-none" name="7" onClick={numberHandler}>7</Button>
                                </Col>
                                }
                            </Row>
                        </Container>
...
{/* ============= 3 WORD ============= */}
                        ...
                        <div className="my-5 py-5 text-center">
                            ...
                            <div>
                                <div className="d-flex justify-content-center">
                                    <ProgressBar className="main-progress" variant="success" striped now={progress} />
                                </div>
            ...
            {choose.length === 9 &&
                <div className="my-5 py-5 text-center">
                    ...
                    <div>
                        <div className="d-flex justify-content-center">
                            <ProgressBar className="main-progress" variant="success" striped now={progress2} />
                        </div>
            ...
            {choose2.length === 9 &&
                <Modal show={display3} centered>
                <Modal.Header>
                    <Modal.Title>🎉 Hasil Tebakan 🎉</Modal.Title>
                </Modal.Header>
                <Modal.Body className="text-center">
                    <h1 className="main-result">{choose2.slice(0, 1) + choose2.slice(4, 5) + choose2.slice(8, 9)}</h1>
                </Modal.Body>
                <Modal.Footer>
                    <Button className="main-reset shadow-none" variant="success" onClick={reset}><BiRotateRight className="reset-icon" /> Tebak Lagi</Button>
                </Modal.Footer>
                </Modal>
            }
...
{/* ============= 4 WORD ============= */}
            ...
            {choose2.length === 16 &&
                ...
                <Modal.Body className="text-center">
                    <h1 className="main-result">{choose2.slice(0, 1) + choose2.slice(5, 6) + choose2.slice(10, 11) + choose2.slice(15, 16)}</h1>
                </Modal.Body>
                <Modal.Footer>
                    <Button className="main-reset shadow-none" variant="success" onClick={reset}><BiRotateRight className="reset-icon" /> Tebak Lagi</Button>
                </Modal.Footer>
...
{/* ============= 5 WORD ============= */}
            ...
            {choose2.length === 25 &&
                ...
                <Modal.Body className="text-center">
                    <h1 className="main-result">{choose2.slice(0, 1) + choose2.slice(6, 7) + choose2.slice(12, 13) + choose2.slice(18, 19) + choose2.slice(24, 25)}</h1>
                </Modal.Body>
                <Modal.Footer>
                    <Button className="main-reset shadow-none" variant="success" onClick={reset}><BiRotateRight className="reset-icon" /> Tebak Lagi</Button>
                </Modal.Footer>
...
{/* ============= 6 WORD ============= */}
            ...
            {choose2.length === 36 &&
                ...
                <Modal.Body className="text-center">
                    <h1 className="main-result">{choose2.slice(0, 1) + choose2.slice(7, 8) + choose2.slice(14, 15) + choose2.slice(21, 22) + choose2.slice(28, 29) + choose2.slice(35, 36)}</h1>
                </Modal.Body>
                <Modal.Footer>
                    <Button className="main-reset shadow-none" variant="success" onClick={reset}><BiRotateRight className="reset-icon" /> Tebak Lagi</Button>
                </Modal.Footer>
...
{/* ============= 7 WORD ============= */}
            ...
            {choose2.length === 49 &&
                ...
                <Modal.Body className="text-center">
                    <h1 className="main-result">{choose2.slice(0, 1) + choose2.slice(8, 9) + choose2.slice(16, 17) + choose2.slice(24, 25) + choose2.slice(32, 33) + choose2.slice(40, 41) + choose2.slice(48, 49)}</h1>
                </Modal.Body>
                <Modal.Footer>
                    <Button className="main-reset shadow-none" variant="success" onClick={reset}><BiRotateRight className="reset-icon" /> Tebak Lagi</Button>
                </Modal.Footer>

    ...
    return (
        <>
            ...
            <Container className="my-5 px-4">
                <h1 className="how-title pb-3">Gimana sih cara mainnya ?</h1>
                <ol className="how-list">
                    ...
                    <li>Kelima <strong>GuessYourCrush</strong> akan menampikan hasil tebakannya, sesuai dengan apa yang kamu pilih sebelumnya. <strong><i><u>Jadi pastikan kamu pilih yang benar yaa :D</u></i></strong></li>
                </ol>
            </Container>
            <Container className="my-5">
                ...
                <ol className="how-list">
                    ...
                    <li>Jika kamu melakukan kesalahan atau salah tekan, kamu dapat refresh halaman tersebut.</li>
                    ...
                    <li>Jika ingin bermain kembali, kamu dapat menekan tombol <strong><i>"Tebak Lagi"</i></strong> pada akhir permainan.</li>
                </ol>
            </Container>
        </>
    )
